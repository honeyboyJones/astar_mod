...
public class AStarScript : MonoBehaviour {
	...
	public GridScript gridScript; //get grid
	public HueristicScript hueristic; //get hueristic

	protected int gridWidth;
	protected int gridHeight;

	GameObject[,] pos; //2D array of game objects with a name pos, same as GridArray

	protected Vector3 start; //start position
	...
	//first initialization inits the second InitAstar 
	protected virtual void InitAstar(){
		//only use name of hueristic gobj
